        ...
        <>
            <div className="max-w-[400px] flex flex-col gap-4 border border-gray-200 p-4 rounded-md">
                ...
                <div className="text-center">
                    <button className="shadow pb-2 appearance-none border rounded py-2 px-3 border-cyan-700 text-bold text-cyan-700 bg-gray-200 leading-tight focus:outline-none focus:shadow-outline mr-1 w-5/12" onClick={cancel}>Cancel</button>            
                    <button className="shadow pb-2 appearance-none border rounded py-2 px-3 border-cyan-700 text-bold text-white bg-cyan-700 leading-tight focus:outline-none focus:shadow-outline ml-1 w-5/12" onClick={addCardItem}>Add</button>            
                </div>
